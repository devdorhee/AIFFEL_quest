# __*마크 저커버그*가 직접 만들어 본 AI 비서 ‘자비스’__
...
<div align="center">자비스 구축을 위해 연결된 시스템 구성  </div><br>
  
__시작은 집안을 연결하는 것부터__  
...
<div align="center">자비스는 현관문 앞 손님의 얼굴을 인식해 누가 방문했는지 알려줍니다.  </div><br>
...
<div align="center">메신저 봇 덕분에 언제 어디서든 자비스에게 메시지 보내기  </div><br>
...
<div align="center">자비스를 위한 iOS 앱 음성 인식 기능  </div><br>
...
---                                                                                                    
# __GPT-4 발표한 오픈AI *'샘 알트만*', "AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다"__
  
> __AI가 일자리를 대체할 것인가? 에 대해서 *알트만*은 이것이 가까운 장래에 일부__ 
> __일자리를 대체할 가능성이 있으며 얼마나 빨리 일어날 수 있는지 걱정하고 있다__  
> __고 밝혔다.__  
...
# __세계 4대 AI 석학 *앤드류 응* 교수, "인공지능 업계에 영원한 봄 왔다"__
###### 동아닷컴 | 업데이트 2023-07-25 09:242023년 7월 25일 09시 24분 
---
...
__AI는 범용 기술, 기술과 도구라는 시각으로 접근해야__  
...
__셀렉트스타 김세엽 대표, “데이터 중심의 AI가 성능 좌우”__  
...
__인공 일반 지능에 우려할 필요 없다, “30년에서 50년 이상 걸릴 것”__  
...
__AI 업계에 영원한 봄은 왔지만, 사회적 합의 필요해__  
...
---
## __회고__
* 영화 속에서만 보던 인공지능 비서같은 것들이 현실로 다가오는게 느껴졌습니다. 아직은 발전시키고 연구해야할 부분들이 남아있지만, 머지않아 고도화된 인공지능 서비스들을 만나볼 수 있을 것 같습니다. 그리고 우리는 이러한 시대적, 기술적 변화의 흐름을 따라 인공지능을 연구개발하거나 활용을 하기 위해 더욱 열심히 학습을 해야겠다는 생각이 들었습니다.  
* 리눅스 명령어와 마크다운 언어 사용에 좀 더 익숙해져야 할 것 같습니다. 그리고 Git과 Github 사용법을 숙지해서 프로젝트 진행 시 문제가 발생하지 않도록 꾸준히 연습해야겠습니다.
