...
<center>자비스 구축을 위해 연결된 시스템 구성</center>  
...
<center>자비스는 현관문 앞 손님의 얼굴을 인식해 누가 방문했는지 알려줍니다.</center>  
...
<center>메신저 봇 덕분에 언제 어디서든 자비스에게 메시지 보내기</center>  
...
<center>자비스를 위한 iOS 앱 음성 인식 기능/<center>  
